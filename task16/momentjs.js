;(function (global, factory) {
	...
	// substring from most specific to least, but move to the next array item if it's a more specific constiant than the current root
	...
	function dayOfYearFromWeekInfo(config) {
		const w, weekYear, week, weekday, dow, doy, temp, weekdayOverflow, curWeek
	...
	function toISOString$1() {
		...
		const seconds = abs$1(this._milliseconds) / 1000,
	...
	hooks.defineLocale("az", {
		months:
			"yanconst_fevral_mart_aprel_may_iyun_iyul_avqust_sentyabr_oktyabr_noyabr_dekabr".split(
				"_"
			),
	...
	hooks.defineLocale("el", {
		...
		calendar: function (key, mom) {
			const output = this._calendarEl[key],
				hours = mom && mom.hours()
	...
	hooks.defineLocale("gom-latn", {
		...
		monthsParseExact: true,
		weekdays: "Aitar_Somar_Mongllar_Budhconst_Birestar_Sukrar_Son'const".split("_"),
	...
	hooks.defineLocale("se", {
		...
		weekdays:
			"sotnabeaivi_vuossárga_maŋŋebárga_gaskavahkku_duorastat_bearjadat_lávconstdat".split(
				"_"
			),
	...
	hooks.defineLocale("tzl", {
		months:
			"Januar_Fevraglh_Març_Avrïu_Mai_Gün_Julia_Guscht_Setemconst_Listopäts_Noemconst_Zecemconst".split(
				"_"
			),
	...
	hooks.defineLocale("uz-latn", {
		months:
			"Yanconst_Fevral_Mart_Aprel_May_Iyun_Iyul_Avgust_Sentabr_Oktabr_Noyabr_Dekabr".split(
				"_"
			),
